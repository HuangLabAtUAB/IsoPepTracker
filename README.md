...
- **Alternative Splicing Event Visualization**: Visualize five types of AS events (SE, A3SS, A5SS, MXE, RI) from rMATS output
...
- **Novel Isoform Analysis**: Identify and analyze novel peptides from alternative splicing events
- **Interactive Plotly Visualizations**: Zoom, pan, and hover for detailed peptide information
- **BLASTP Integration**: Search peptides against protein databases for functional annotation
- **SplAdder Support**: Process and visualize SplAdder alternative splicing predictions
- **Memory-Efficient Design**: Gene-by-gene loading with LRU caching for handling genome-scale data
